...
#ifndef PROTOBUF_INCLUDED_foo_2epb
#define PROTOBUF_INCLUDED_foo_2epb
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_foo_2epb 

namespace protobuf_foo_2epb {
...
class Foo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:foo.Foo) */ {
 public:
  Foo();
  virtual ~Foo();
 ...
 private:
  ...
  friend struct ::protobuf_foo_2epb::TableStruct;
};
// ===================================================================
...
inline const ::std::string& Foo::text() const {
  // @@protoc_insertion_point(field_get:foo.Foo.text)
  return text_.GetNoArena();
}
inline void Foo::set_text(const ::std::string& value) {
  
  text_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:foo.Foo.text)
}
#if LANG_CXX11
inline void Foo::set_text(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:foo.Foo.text)
}
#endif
inline void Foo::set_text(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:foo.Foo.text)
}
inline void Foo::set_text(const char* value, size_t size) {
  
  text_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:foo.Foo.text)
}
inline ::std::string* Foo::mutable_text() {
  
  // @@protoc_insertion_point(field_mutable:foo.Foo.text)
  return text_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Foo::release_text() {
  // @@protoc_insertion_point(field_release:foo.Foo.text)
...
inline void Foo::set_allocated_text(::std::string* text) {
  ...
  // @@protoc_insertion_point(field_set_allocated:foo.Foo.text)
}
...
inline ::google::protobuf::int32 Foo::numbers(int index) const {
  // @@protoc_insertion_point(field_get:foo.Foo.numbers)
  return numbers_.Get(index);
}
inline void Foo::set_numbers(int index, ::google::protobuf::int32 value) {
  numbers_.Set(index, value);
  // @@protoc_insertion_point(field_set:foo.Foo.numbers)
}
inline void Foo::add_numbers(::google::protobuf::int32 value) {
  numbers_.Add(value);
  // @@protoc_insertion_point(field_add:foo.Foo.numbers)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
Foo::numbers() const {
  // @@protoc_insertion_point(field_list:foo.Foo.numbers)
  return numbers_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
Foo::mutable_numbers() {
  // @@protoc_insertion_point(field_mutable_list:foo.Foo.numbers)
  return &numbers_;
}
...
#endif  // PROTOBUF_INCLUDED_foo_2epb
